    ...
    def _decode(self, coded_msgs):
        ...
        for index, (k, v) in enumerate(coded_msgs.iteritems()):
            for code in v:
                ...
                pickle_time = time.time()-current_time
                current_time = time.time()
                ...
                aggregate_time = time.time() - current_time
                print("pickle time: {}, decode {} time cost {}, aggregate time {}".format(pickle_time, grad.shape, decode_time, aggregate_time))
